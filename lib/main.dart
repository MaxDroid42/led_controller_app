...
import 'package:led_strip_remote/actionCardsAlpha.dart';
import 'package:shared_preferences/shared_preferences.dart';

// TODO: import from actionCards package
...
void main() => runApp(MaterialApp(home: RemotePage()));
...
class _RemotePageState extends State<RemotePage> {
  ...
  //TODO: make to stateful widget and move error handling
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            ...
            ModePicker(selectedDevice: selectedDevice)
          ],
        ),
      ),
    );
